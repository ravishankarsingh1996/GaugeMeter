...
public class GaugeView extends View {
    ...
    public static final int INNER_CIRCLE_COLOR = Color.argb(0, 190, 215, 123);
    public static final int OUTER_CIRCLE_COLOR = Color.argb(0, 205, 231, 132);
    ...
    public static final int[] OUTER_SHADOW_COLORS = {Color.argb(0, 255, 254, 187), Color.argb(20, 255, 247, 219),
    ...
    //Custom created properties
    private String mUserTargetWeight;
    ...
    public Paint getDefaultNeedleLeftPaint() {
        final Paint paint = new Paint(Paint.ANTI_ALIAS_FLAG);
        paint.setColor(Color.rgb(148, 223, 80));
        return paint;
    }
...
//                canvas.drawLine(0.5f, y1, 0.5f, y2, paint);
    ...
    private void drawText(Canvas canvas, String value, float x, float y, Paint paint) {
        ...
        //Current value needle pointing to is stored in textValue
        final String textValue = !TextUtils.isEmpty(mTextValue) ? mTextValue : valueString(mCurrentValue);
        if (value.equals(mUserTargetWeight)) {
            paint.setColor(Color.rgb(148, 223, 80));
        } else if (value.equals(textValue))
            paint.setColor(Color.rgb(255, 255, 255));
    ...
    private void drawNeedle(final Canvas canvas) {
        if (mNeedleInitialized) {
            ...
            canvas.drawCircle(0.5f, 0.5f, 0.02f, mNeedleScrewPaint);
    ...
    private void setNeedleShadowPosition(final float angle) {
        if (angle > 180 && angle < 360) {
            ...
            mNeedleRightPaint.setShadowLayer(0, 0, 0, Color.parseColor("#94df50"));
            mNeedleLeftPaint.setShadowLayer(0.01f, -0.005f, 0.005f, Color.argb(255, 148, 223, 80));
        } else {
            // Move shadow from left to right
            mNeedleLeftPaint.setShadowLayer(0, 0, 0, Color.parseColor("#94df50"));
            mNeedleRightPaint.setShadowLayer(0.01f, 0.005f, -0.005f, Color.argb(255, 148, 223, 80));
        }
    }
    ...
    public void setTargetWeight(String value){
        mUserTargetWeight = value;
    }
